...
-- concrete ExtendKam of Extend =
--   CatKam ** ExtendFunctor with
--     (Grammar = GrammarKam) **
...
--      let vp : ResKam.VP = insertObjPre (\\_ => vpslash.c2 ++ np.s ! NPAcc) vpslash ;
--          a = AgP3Sg Neutr
--      in
--      lin NP {s = \\_ => vp.ad ! a ++ vp.prp ++ vp.s2 ! a ; a = a} ;


--   oper passVPSlash : VPSlash -> Str -> ResKam.VP =
--    \vps,ag ->
--     let
--       be = predAux auxBe ;
--       ppt = vps.ptp
