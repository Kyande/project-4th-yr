...
lin
 ...
 ---- trousers_N = regN "trousers" ;
  ...
  worm_N = regN "worm" ;
  year_N = regN "year" ;
  blow_V = IrregKam.blow_V ;
  breathe_V = dirV2 (regV "breathe") ;
  burn_V = IrregKam.burn_V ;
  dig_V = IrregKam.dig_V ;
  fall_V = IrregKam.fall_V ;
  float_V = regV "float" ;
  flow_V = regV "flow" ;
  fly_V = IrregKam.fly_V ;
  freeze_V = IrregKam.freeze_V ;
  give_V3 = mkV3 give_V noPrep noPrep ;
  laugh_V = regV "laugh" ;
  lie_V = IrregKam.lie_V ;
  play_V = regV "play" ;
  sew_V = IrregKam.sew_V ;
  sing_V = IrregKam.sing_V ;
  sit_V = IrregKam.sit_V ;
  smell_V = regV "smell" ;
  spit_V = IrregKam.spit_V ;
  stand_V = IrregKam.stand_V ;
  swell_V = IrregKam.swell_V ;
  swim_V = IrregKam.swim_V ;
  think_V = IrregKam.think_V ;
  turn_V = regV "turn" ;
  vomit_V = mkV "vomit" "vomited" ;

  bite_V2 = dirV2 IrregKam.bite_V ;
  count_V2 = dirV2 (regV "count") ;
  cut_V2 = dirV2 IrregKam.cut_V ;
